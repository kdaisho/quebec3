<div id="mc_embed_signup">
	<h3 class="signup-title is-size-5 has-text-weight-bold has-text-centered has-text-white">まだやってます<br>新着記事通知<span class="no-wrap">サービス</span></h3>
	<div class="signup-contents box">
		<p class="">ここにあなたのメールアドレスをぶち込んでおけば、記事が更新された際お知らせのメールが届きます。</p>
		...
		<div class="tags has-addons m-t-30">
			<span class="tag" style="margin-left: auto;"><small>安心と信頼の&nbsp;Quebec3</small></span>
		</div>
	</div>
</div>