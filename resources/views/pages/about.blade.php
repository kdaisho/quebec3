...
<div class="section container">
	<p class="is-size-5 is-size-6-mobile">Quebec3はカナダのケベック州、モントリオールという街に住む以下の人が好き勝手に書いてるブログです。海外移住、カナダでの暮らし、労働環境なんかを物凄く歪んだ視点から書いてますのでショックを受けないでください。</p>
	<hr class="m-b-20">
	<h3 class="title is-size-4">書いてる人:</h3>
	{{-- <img src="/images/profile.jpg" alt="Kyoshin-heiのプロファイル"> --}}
	...
	<p class="m-b-20"><span class="icon"><i class="has-text-danger fa fa-chevron-right"></i></span>( ´ｰ`)ﾄﾞﾔ　日本で話せるようにしておきました。<span class="icon">
		<a class="link" href="{{ url('#')}}"><i class="fa fa-arrow-right m-b-20"></i></span>僕の英語練習法</a></p>
	...
	<p class="m-b-20"><span class="icon"><i class="has-text-danger fa fa-chevron-right"></i></span>あたぼうよ。</p>
</div>
